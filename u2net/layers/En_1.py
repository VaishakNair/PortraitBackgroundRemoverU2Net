...
class En_1(layers.Layer):
    ...
    def call(self, inputs):
        ...
        green_3_output = self.green_3(layers.Concatenate()(
            [blue_5_output, white_output]))  # TODO Check whether concatenation order is correct or not:

        pink_1_output = self.pink_1(layers.Concatenate()([blue_4_output, layers.UpSampling2D(size=(2, 2))(green_3_output)]))
        ...
        pink_5_output = self.pink_5(layers.Concatenate()([green_2_output, pink_4_output]))

        return layers.Add()([green_1_output, pink_5_output])

...
saved_model_save_dir = pathlib.Path("/home/vaishak/Downloads/tflite/u2netlite/saved_model")
...
def get_saved_model_from_keras_model():
    ...
    keras_model.save(saved_model_save_dir / saved_model_name, save_format="tf")

    return tf.keras.saving.load_model(saved_model_save_dir / saved_model_name), saved_model_name
...
if __name__ == "__main__":
    ...
    converter = tf.lite.TFLiteConverter.from_saved_model(
        str(saved_model_save_dir / saved_model_name))  # path to the SavedModel directory
